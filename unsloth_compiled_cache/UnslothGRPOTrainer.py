...
def grpo_compute_loss(
    ...
    **kwargs
    ...
    if advantage_schedule == 'none':
        ...
        unsqueezed_advantages += execution_token_entropy_schedule_ceil / ( 1 + (normalized_execution_per_token_entropy - execution_token_entropy_schedule_ratio * initial_normalized_execution_token_entropy).exp() ) * planning_token_mask * torch.abs(unsqueezed_advantages)
